...
// v36: Árbol genealógico 3G en PWA, navegación de crías descendientes y fix de sintaxis en app.js.
var CACHE = "pwa-ja-v36"; // subir versión al cambiar app.js/style.css/templates (cache-first)
var PRECACHE = [
  "/",
  "/login",
  "/offline.html",
